...
# instances=("burma14" "ulysses16" "gr17" "gr21" "ulysses22" "gr24" "fri26" "bayg29" "bays29") # bnb
make
# instances=("rat99")
...
for instance in "${instances[@]}"; do
    ...
    echo "instancia;custo;tempo" > "executions-time0/$instance.csv"
    for i in {1..10}; do
        echo "  Execução $i"
        ./tsp instances/$instance.tsp ${seeders[i-1]} 2 >> "executions-time0/$instance.csv"
    done
done
