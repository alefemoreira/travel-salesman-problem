...
def get_min_cost_execution(csv_file):
    data = np.genfromtxt('executions/' + csv_file, delimiter=';', dtype=None, names=True, encoding=None)
...
if __name__ == '__main__':
    ...
    csv_files = ["burma14.csv","ulysses16.csv","gr17.csv","gr21.csv","ulysses22.csv","gr24.csv","fri26.csv","bayg29.csv","bays29.csv","dantzig42.csv","swiss42.csv","att48.csv","gr48.csv","hk48.csv","eil51.csv","berlin52.csv","brazil58.csv","st70.csv","eil76.csv","pr76.csv","gr96.csv","rat99.csv","kroB100.csv","kroC100.csv","kroD100.csv","kroE100.csv","rd100.csv","kroA100.csv","eil101.csv","lin105.csv","pr107.csv","gr120.csv","pr124.csv","bier127.csv","ch130.csv","pr136.csv","gr137.csv","pr144.csv","kroA150.csv","kroB150.csv","ch150.csv","pr152.csv","u159.csv","si175.csv","brg180.csv","rat195.csv","d198.csv","kroA200.csv","kroB200.csv","gr202.csv","ts225.csv","tsp225.csv","pr226.csv","gr229.csv","gil262.csv","pr264.csv","a280.csv","pr299.csv","lin318.csv","linhp318.csv","rd400.csv","fl417.csv","gr431.csv","pcb442.csv","d493.csv","att532.csv","ali535.csv","si535.csv"]  # Add your file names here

    # Get min cost and execution time from each file
    min_values_data = read_csv_files_and_get_min_values(csv_files)

    # Save the data to a new CSV file
    output_csv_file = 'min_values_output.csv'
